...
def genUmbrellaWithHeights(degree = 3, rows = 5, cols = 5, height_scales = None, minHeight = 64, useOverHang = False, armPlateEdgeAxisOffset = 10, armJointAxisOffset = 10, minOverHang = 5.0, plate_thickness = 3.0, edge_length = 30, base_mesh = None, scaling = True, json_filename = 'grid_dump'):
    edgeLength = edge_length
    t_mesh = None
    uv_mesh = None
    # max_overhang = edgeLength # overhang = surplomb (porte-à-faux)
